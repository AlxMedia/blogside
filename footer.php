		...
		<div class="container" id="footer-bottom">
			...
			<?php if ( has_nav_menu('footer') ): ?>
				<div id="wrap-nav-footer" class="wrap-nav container-inner">
					<?php \Blogside\Nav::nav_menu(array('theme_location'=>'footer','menu_id' => 'nav-footer','fallback_cb'=> false)); ?>
				</div>
			<?php endif; ?>
			...
			<div class="container-inner">
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="credit">
							<p><?php esc_html_e('Powered by','blogside'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','blogside'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
