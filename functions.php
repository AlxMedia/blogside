...
/*  Page title
/* ------------------------------------ */
if ( ! function_exists( 'blogline_page_title' ) ) {

	function blogline_page_title() {
		global $post;
...
/*  Custom rss feed
/* ------------------------------------ */
if ( ! function_exists( 'blogline_feed_link' ) ) {

	function blogline_feed_link( $output, $feed ) {
...
add_filter( 'feed_link', 'blogline_feed_link', 10, 2 );
